...
class CurlHelper
{
	 ...
	 */
	public static function curlHttp($url, $method, $post_data = null, $is_encode = false, $timeout = 5, $json = true, $useragent = null, $cookie = null)
	{
		self::init();
...
//		curl_setopt($curl_handle, CURLOPT_HTTPHEADER, array('Expect:'));
		...
		curl_close($curl_handle);
		// var_dump(self::$http_code, self::$http_header, self::$http_info);
		return $response;
	}
